...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  ...
  try {
    ...
    let gifUrl = "https://telegra.ph/file/4c3e4b782c82511b3874d.mp4";await conn.sendMessage(m.chat, {video: {url: gifUrl}, gifPlayback: true, caption: text.trim(), mentions: [m.sender]}, {quoted: m});
